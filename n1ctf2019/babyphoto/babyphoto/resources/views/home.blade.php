...
<!-- Add your site or app content here -->
  <div class="hero-full-container background-image-container white-text-container">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <h2>WELCOME TO N1CTF2019</h2>
          <p>It's one Unfinished CMS</p>
          <p>BTW,It looks easy</p>
          <br>
          <a href="./userpage/{{Auth::user()->id}}" class="btn btn-default btn-lg" title="">Click Here</a>
        </div>
      </div>
    </div>
  </div>
